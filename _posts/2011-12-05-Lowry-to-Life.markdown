...
<object width="640" height="360"><param name="movie" value="http://www.youtube.com/v/LhSUx_MlMAk?version=3&amp;hl=en_US&amp;start=263"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/LhSUx_MlMAk?version=3&amp;hl=en_US&amp;start=263" type="application/x-shockwave-flash" width="640" height="360" allowscriptaccess="always" allowfullscreen="true"></embed></object>
