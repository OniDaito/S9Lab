...
Night mode was actually trickier in some ways. There was less in the way of feedback and indeed, the effects were much more subtle and less well defined. Given a series of lat/lon points and a value, how do you create an effect similar to NASA's famous Black Marble image?<br/><br/>The answer, I felt, was a little cellular automata!
